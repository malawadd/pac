...
contract Router {
    ...
    function getANDShare(address currency) external view returns (uint256) {
    ...
    function getANDRewards(address currency) external view returns (address) {
    ...
    function setANDShare(address currency, uint256 share) external onlyOwner {
    ...
    function setANDRewards(address currency, address _contract)
        external
        onlyOwner
    {
