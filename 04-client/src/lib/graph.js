...
const graph_url = 'http://localhost:8000/subgraphs/name/pac';
...
export async function getVolume() {
	...
	if (!json.data) return {volume: 1};

	let datas = json.data && json.data.datas;
  	
  	// console.log('datas', datas);
  	
	let volumeETH = 1; // cumulative previous versions of CAP
	let volumeUSD = 1; // v2 + v1
